...
Notes and Questions - Meeting w Courtland Kelly 20200626
-normality of residuals??? meta-regression??
-shorter term studies included?
-how to treat zf/cf?
-difference after multiplication by BD? (if not reported in the treatments - how can we get at stocks) - use MEMS model to predict BD and thus change in stocks
-leave in MAP/MAT ? aridity index instead?
   #to combine datasets - use fertilized controls when possible= had a lower effect size (will not overestimate the effect?) Can we just include both cf and zf from a single paper, where autocorrelation is accounted for in the ACC number???

-GitHub
Completed: 20200713
-Send Courtland:: Gurevitch 1992
-use latitute (not post/neg) BUT as a "north-ness" (ONLY CHANGED ACC 843 and 188)
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
STATS OVERVIEW:
mixed model for meta-analysis (regression?) with maximum likelihood #random effect is study, 
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
WORKING ON:
glmulti - get the df.c_ratio_all data to work -> make sure the cf and zf dataframes are combinging correctly

Bootstrap Qb values for different parameters - how can this incorporate ACC (strata?)? Autocorrelation w depth?
    -if depth is just another moderator, no testing of how the other parameters vary with depth...
...
COMPLETED:
        ...
        7) analyze fertilized and zero controls #to combine datasets - use fertilized controls when possibl e= had a lower effect size (will not overestimate the effect?)
