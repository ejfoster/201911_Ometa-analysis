...
~~ Here Courtland adds a comment to see how version control works!!
...
a. Is the effect different from zero? (are there outliers of effect sizes?)
      -YES, bootrapped mean effect sizes for the global meta-analysis are diffferent from zeo - both with zero control and fertlizer control (positive effect)
