...
df1 %>% dplyr::select(X3,ACC, 
                      ...
                      X_cf, SE_cf, SD_cf, N_cf, X_a, SE_a, SD_a, N_a, X_cmin, SE_cmin, SD_cmin, N_cmin ) -> df2 
...
I2.comb = max ((100*( (QT.comb-(K.comb-1))/QT.comb)),0) #9.7% of variance explained by ACC
 #chisq.test
 1-pchisq(q=QT.comb, df=1) #significant
1-pchisq(q=I2.comb, df=(K.comb-1)) #not significant

```

```{r, 9. calc Qb for all paramters}
...
#measurements need to be independent
